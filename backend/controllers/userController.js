...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name_1, phone, role, profilePicture, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, email = _a.email, password = _a.password, name_1 = _a.name, phone = _a.phone, role = _a.role, profilePicture = _a.profilePicture;
                if (!email || !password) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (isNaN(id)) {
                    return [2 /*return*/, res.status(400).json({ message: 'User ID is required and must be a number' })];
                }
            ...
            case 1:
                ...
                return [2 /*return*/, res.status(200).json({ message: 'User found', user: user })];
            case 2:
                error_2 = _a.sent();
